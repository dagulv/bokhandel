...
/** source: C:\xampp\htdocs\esport/wp-content/themes/esport/views//layout/main-menu.latte */
final class Template781cfafa31 extends Latte\Runtime\Template
{
    ...
    <nav class="navbar">
      ...
      >
        ';
		echo LR\Filters::escapeHtmlText(tr_get_media('logo-test.svg')) /* line 10 */;
		echo '
      </a>
      <button 
